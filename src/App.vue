  ...
  <div id="app" :style="{'background-image':'url(https://www.nanopass.io/assets/images/cyberpunk_hq.png)'}" class="hello" >
    ...
    <b-row align-h="center" class="mt-5">
      <b-card-group deck>
        ...
        <b-card bg-variant="danger" img-src="https://i.ibb.co/3Wp85b2/rei.png" height="580" text-variant="white" header="Vote @reincanno" class="text-center" footer-tag="footer">
